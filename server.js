...
http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (pathname === '/onboarding' || pathname.startsWith('/onboarding/')) { if (!requireSession(req, res)) return; return serveFile(res, path.join(root, 'app.html')); }
