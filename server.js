  ...
  try {
    ...
    if (pathname === '/api/session' && req.method === 'GET') {
      ...
      return json(res, 200, {
        ...
        next: user ? (!user.onboardingComplete ? `/onboarding/${firstIncomplete(user)}` : '/console') : '/login',
      });
    }
